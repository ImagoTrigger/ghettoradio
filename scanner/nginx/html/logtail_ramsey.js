...
function show_log() {
    ...
    for (var i = 0; i < arrayLength; i++) {
        var n = t_a[i].indexOf("Encrypted");
        if (n >= 0) {
            t_a[i] = "<font color=red size=-2>"+t_a[i]+"</font><br/>\n";
        } else {
            t_a[i] = "<font color=black size=-2>"+t_a[i]+"</font><br/>\n";
        }
    }
    t = t_a.join("\n");
